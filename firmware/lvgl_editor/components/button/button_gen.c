...
lv_obj_t * button_create(lv_obj_t * parent, const char * label)
{
    ...
    if (!style_inited) {
        ...
        lv_style_set_border_opa(&style_focused, (255 * 100 / 100));
    ...
    lv_obj_add_style(lv_button_0, &style_focused, LV_STATE_FOCUS_KEY);
