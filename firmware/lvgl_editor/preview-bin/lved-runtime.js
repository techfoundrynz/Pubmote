...
var ASM_CONSTS = {
 ...
 1400046: ($0) => { if (Module['canvas']) { Module['canvas'].style['cursor'] = UTF8ToString($0); } },  
 1400129: () => { if (Module['canvas']) { Module['canvas'].style['cursor'] = 'none'; } },  
 1400198: () => { return window.innerWidth; },  
 1400228: () => { return window.innerHeight; }
};
