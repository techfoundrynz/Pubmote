...
var ASM_CONSTS = {
 ...
 1398238: ($0) => { if (Module['canvas']) { Module['canvas'].style['cursor'] = UTF8ToString($0); } },  
 1398321: () => { if (Module['canvas']) { Module['canvas'].style['cursor'] = 'none'; } },  
 1398390: () => { return window.innerWidth; },  
 1398420: () => { return window.innerHeight; }
};
