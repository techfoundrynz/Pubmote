...
var ASM_CONSTS = {
 ...
 1399342: ($0) => { if (Module['canvas']) { Module['canvas'].style['cursor'] = UTF8ToString($0); } },  
 1399425: () => { if (Module['canvas']) { Module['canvas'].style['cursor'] = 'none'; } },  
 1399494: () => { return window.innerWidth; },  
 1399524: () => { return window.innerHeight; }
};
