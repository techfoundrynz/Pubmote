...
static void update_value(lv_obj_t * speed_gauge, int val);
static void value_observer_cb(lv_observer_t * obs, lv_subject_t * subject);
static void update_max_value(lv_obj_t * speed_gauge, int val);
...
void speed_gauge_bind_speed(lv_obj_t * speed_gauge, lv_subject_t * bind_speed)
{
    ...
    // Update with current
    update_value(speed_gauge, lv_subject_get_int(bind_speed));
}
...
void speed_gauge_bind_max_speed(lv_obj_t * speed_gauge, lv_subject_t * bind_max_speed)
{
    ...
    // Update with current
    update_max_value(speed_gauge, lv_subject_get_int(bind_max_speed));
}
...
static void max_value_observer_cb(lv_observer_t * obs, lv_subject_t * subject)
{
    update_max_value(lv_observer_get_user_data(obs), lv_subject_get_int(subject));
}