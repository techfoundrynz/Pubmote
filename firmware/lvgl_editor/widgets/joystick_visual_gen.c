...
#include "joystick_visual_private_gen.h"
...
void joystick_visual_constructor_hook(lv_obj_t * obj);
void joystick_visual_destructor_hook(lv_obj_t * obj);
void joystick_visual_event_hook(lv_event_t * e);

/**********************
 *  STATIC PROTOTYPES
 **********************/

static void joystick_visual_constructor(const lv_obj_class_t * class_p, lv_obj_t * obj);
static void joystick_visual_destructor(const lv_obj_class_t * class_p, lv_obj_t * obj);
static void joystick_visual_event(const lv_obj_class_t * class_p, lv_event_t * e);

/**********************
 *  STATIC VARIABLES
 **********************/

const lv_obj_class_t joystick_visual_class = {
    .base_class = &lv_obj_class,
    .constructor_cb = joystick_visual_constructor,
    .destructor_cb = joystick_visual_destructor,
    .event_cb = joystick_visual_event,
    .instance_size = sizeof(joystick_visual_t),
    .editable = 1,
    .name = "joystick_visual"
};
...
{
    LV_LOG_INFO("begin");
    lv_obj_t * obj = lv_obj_class_create_obj(&joystick_visual_class, parent);
...
static void joystick_visual_constructor(const lv_obj_class_t * class_p, lv_obj_t * obj)
{
    ...
    joystick_visual_t * widget = (joystick_visual_t *)obj;
    ...
    joystick_visual_constructor_hook(obj);
...
static void joystick_visual_destructor(const lv_obj_class_t * class_p, lv_obj_t * obj)
{
    ...
    joystick_visual_destructor_hook(obj);
}
...
static void joystick_visual_event(const lv_obj_class_t * class_p, lv_event_t * e)
{
    ...
    res = lv_obj_event_base(&joystick_visual_class, e);
    if(res != LV_RESULT_OK) return;

    joystick_visual_event_hook(e);
}
