...
static void input_preview_constructor(const lv_obj_class_t * class_p, lv_obj_t * obj)
{
    ...
    lv_obj_set_height(lv_obj_0, 4);
    lv_obj_set_width(lv_obj_0, 100);
    lv_obj_set_style_bg_color(lv_obj_0, lv_color_hex(0xb94040), 0);
    ...
    lv_obj_set_style_bg_color(lv_obj_1, lv_color_hex(0xb94040), 0);
    ...
    lv_obj_set_width(lv_obj_2, 100);
    lv_obj_set_height(lv_obj_2, 100);
    lv_obj_set_style_radius(lv_obj_2, lv_pct(50), 0);
    lv_obj_set_style_border_width(lv_obj_2, 4, 0);
    lv_obj_set_style_border_color(lv_obj_2, lv_color_hex(0x4e4e4e), 0);
    ...
    lv_obj_set_style_border_color(lv_obj_3, lv_color_hex(0x00e6ff), 0);
    ...
    lv_obj_set_height(lv_obj_4, 20);
    lv_obj_set_width(lv_obj_4, 20);
    ...
    lv_obj_set_style_bg_color(lv_obj_5, lv_color_hex(0xffffff), 0);
    ...
    lv_obj_set_style_bg_color(lv_obj_6, lv_color_hex(0xffffff), 0);
