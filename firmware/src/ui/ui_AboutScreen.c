...
void ui_AboutScreen_screen_init(void)
{
    ...
    lv_obj_add_event_cb(ui_AboutScreen, scr_unloaded_delete_cb, LV_EVENT_SCREEN_UNLOADED, ui_AboutScreen_screen_destroy);
    ...
    lv_obj_remove_flag(ui_AboutHeader, LV_OBJ_FLAG_CLICKABLE | LV_OBJ_FLAG_SCROLL_MOMENTUM);      /// Flags
    ...
    lv_obj_remove_flag(ui_AboutBody, LV_OBJ_FLAG_GESTURE_BUBBLE | LV_OBJ_FLAG_SNAPPABLE |
    ...
    lv_obj_remove_flag(ui_VersionInfoContainer, LV_OBJ_FLAG_CLICKABLE | LV_OBJ_FLAG_SCROLLABLE);      /// Flags
    ...
    lv_obj_remove_flag(ui_VersionInfoLabel, LV_OBJ_FLAG_SCROLLABLE);      /// Flags

    ui_UpdateButton = lv_button_create(ui_VersionInfoContainer);
    ...
    lv_label_set_text(ui_UpdateButtonLabel, "Check for updates");
    ...
    lv_obj_remove_flag(ui_DebugInfoContainer, LV_OBJ_FLAG_CLICKABLE | LV_OBJ_FLAG_SCROLLABLE);      /// Flags
    ...
    lv_obj_remove_flag(ui_DebugInfoLabel, LV_OBJ_FLAG_SCROLLABLE);      /// Flags
