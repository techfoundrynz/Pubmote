...
void ui_MenuScreen_screen_init(void)
{
    ...
    lv_obj_remove_flag(ui_MenuBody, LV_OBJ_FLAG_GESTURE_BUBBLE | LV_OBJ_FLAG_SNAPPABLE |
    ...
    ui_MenuBackButton = lv_button_create(ui_MenuBody);
    ...
    ui_MenuConnectButton = lv_button_create(ui_MenuBody);
    ...
    lv_obj_remove_flag(ui_MenuConnectButton, LV_OBJ_FLAG_SCROLLABLE);      /// Flags
    ...
    ui_MenuPocketModeButton = lv_button_create(ui_MenuBody);
    ...
    lv_obj_remove_flag(ui_MenuPocketModeButton, LV_OBJ_FLAG_SCROLLABLE);      /// Flags
    ...
    ui_MenuSettingsButton = lv_button_create(ui_MenuBody);
    ...
    ui_MenuCalibrateButton = lv_button_create(ui_MenuBody);
    ...
    lv_obj_remove_flag(ui_MenuCalibrateButton, LV_OBJ_FLAG_SCROLLABLE);      /// Flags
    ...
    ui_MenuPairButton = lv_button_create(ui_MenuBody);
    ...
    lv_obj_remove_flag(ui_MenuPairButton, LV_OBJ_FLAG_SCROLLABLE);      /// Flags
    ...
    ui_MenuAboutButton = lv_button_create(ui_MenuBody);
    ...
    lv_obj_remove_flag(ui_MenuAboutButton, LV_OBJ_FLAG_SCROLLABLE);      /// Flags
    ...
    ui_MenuShutdownButton = lv_button_create(ui_MenuBody);
    ...
    lv_obj_remove_flag(ui_MenuShutdownButton, LV_OBJ_FLAG_SCROLLABLE);      /// Flags
