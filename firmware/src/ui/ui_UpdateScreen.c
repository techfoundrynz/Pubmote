...
void ui_UpdateScreen_screen_init(void)
{
    ...
    lv_obj_remove_flag(ui_UpdateScreen, LV_OBJ_FLAG_SCROLLABLE);      /// Flags
    lv_obj_add_event_cb(ui_UpdateScreen, scr_unloaded_delete_cb, LV_EVENT_SCREEN_UNLOADED, ui_UpdateScreen_screen_destroy);
    ...
    lv_obj_remove_flag(ui_UpdateContent, LV_OBJ_FLAG_CLICKABLE | LV_OBJ_FLAG_SCROLLABLE);      /// Flags
    ...
    lv_obj_remove_flag(ui_UpdateHeader, LV_OBJ_FLAG_CLICKABLE | LV_OBJ_FLAG_SCROLLABLE);      /// Flags
    ...
    lv_obj_remove_flag(ui_UpdateBody, LV_OBJ_FLAG_CLICKABLE);      /// Flags
    ...
    lv_dropdown_set_options(ui_UpdateBodyDropdown, "Option 1\nOption 2\nOption 3");
    ...
    lv_obj_remove_flag(ui_UpdateFooter, LV_OBJ_FLAG_CLICKABLE | LV_OBJ_FLAG_SCROLLABLE);      /// Flags
    ...
    ui_UpdateSecondaryActionButton = lv_button_create(ui_UpdateFooter);
    ...
    lv_obj_remove_flag(ui_UpdateSecondaryActionButton, LV_OBJ_FLAG_SCROLLABLE);      /// Flags
    ...
    ui_UpdatePrimaryActionButton = lv_button_create(ui_UpdateFooter);
    ...
    lv_obj_remove_flag(ui_UpdatePrimaryActionButton, LV_OBJ_FLAG_SCROLLABLE);      /// Flags
