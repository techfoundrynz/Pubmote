...
function FileUpload({ label, icon, file, onChange, accept = ".bin" }: FileUploadProps) {
  ...
  return (
    <div
      ...
      className={cn(
        ...
        isDragging && !isInvalid && "bg-blue-900/20 border-blue-500",
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between mb-6">
        <p>
          Upload your desired firmware files here. You can either upload a complete firmware package
